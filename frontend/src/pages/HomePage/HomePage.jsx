...
function HomePage({ addToPlayList }) {
    const albums = [
        { title: 'Song 1', album: 'Album A', artist: 'Artist 1', duration: '3:54', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnvClIz-DxZEVtkeerXF1qz8xAn7LBjknnLA&s' },
        { title: 'Song 2', album: 'Album B', artist: 'Artist 2', duration: '3:54', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPP5ZnNwn-fR38DkWIxCcBcwu5eYaYWcOVYg&s' },
                    ...
                    <div className="album-grid">
                        {albums.map((album, index) => (
                            <AlbumCard
                                ...
                                onAddToPlayList={() => addToPlayList({ ...album, comments: [] })} // 确保每首歌有comments数组
                            />
                        ))}
                    </div>
                </div>
